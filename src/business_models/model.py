...
#     debt_service_coverage_ratio, debt_to_income, loan_to_cost, loan_to_value,\
#     cash_of_cash, return_on_investment, noi, cap_rate
#
...
#                  lawyer_cost: int = 0,
#                  escort_costs: int = 0,
#                  additional_transaction_costs_dic: Optional[Dict[str, int]] = None,
#                  renovation_expenses_dic:   Optional[Dict[str, int]] = None,
...
#                self.calculate_constructor_index_linked_compensation()
#
...
#
#     def calculate_annual_property_management_fees(self) -> int:
#         return 12 * self.calculate_monthly_property_management_fees()
#
...
#
#     def calculate_monthly_vacancy_cost(self):
#         return round(self.vacancy_percentage * self.real_estate_property.monthly_rent_income)
#
#     def calculate_annual_vacancy_cost(self):
#         return 12 * self.calculate_monthly_vacancy_cost()
#
...
#     # Selling
#
#     def estimate_sale_price(self, annual_appreciation_percentage: Optional[float] = None) -> int:
...
#         return round(self.real_estate_property.after_repair_value * np.power((1 + annual_appreciation_percentage / 100),
#                                                                              self.years_to_exit))
#
...
#             self.mortgage.get_remain_balances()[(self.years_to_exit - self.years_until_key_reception) * 12])
#
#     # General
#
...
#                                                      0 if i < self.years_until_key_reception else self.calculate_annual_operating_expenses()
#                                                      for i in range(self.years_to_exit)] + [0]
#
...
#     # Plotting Methods
#
#     def plot_irr_vs_equity_percentage(self):
...
#         plt.show()
#
#     def plot_cash_flow_vs_equity_percentage(self):
#         x_s = np.linspace(25, 100, (100 - 25) // 5 + 1)
#         y_s = []
#         for x in x_s:
#             self.equity_required_by_percentage = x
...
#         if annual_appreciation_percentage is None:
#             annual_appreciation_percentage = self.real_estate_property.annual_appreciation_percentage
#         return self.real_estate_property.after_repair_value * np.power((1 + annual_appreciation_percentage / 100),
#                                                                        years)
#
...
#         loan_remain_balance = [self.mortgage.get_annual_remain_balances()[0]] * self.years_until_key_reception + [
...
#         plt.show()
#
#     def annual_irr_vs_purchase_price(self):
...
#         plt.show()
#
#     def annual_cap_rate_vs_purchase_price(self):
#         x_s = [self.real_estate_property.purchase_price + step * 50_000 for step in range(-4, 5)]
#         y_s = []
#         for x in x_s:
#             self.real_estate_property.purchase_price = x
...
#         plt.show()
#
#     def annual_irr_vs_construction_input_index_annual_growth(self):
...
#         plt.show()
#
#     def annual_irr_vs_annual_appreciation_percentage(self):
...
#         plt.show()
#
#     def annual_irr_vs_rent_price(self):
...
#         plt.show()
#
#     def annual_cash_flow_vs_rent_price(self):
#         x_s = [self.real_estate_property.monthly_rent_income + step * 200 for step in range(-4, 5)]
#         y_s = []
#         for x in x_s:
#             self.real_estate_property.monthly_rent_income = x
...
#         plt.show()
#
#     def annual_irr_vs_mortgage_interest_only_period(self):
...
#
#     model = RealEstateModel(investors_portfolio=investors_portfolio,
#                             mortgage=mortgage,
...
#     print(model.annual_irr_vs_purchase_price())
