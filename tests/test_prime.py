...
class TestPrime(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mortgage_track = Prime(
            interest_rate=4 / 100,
            num_payments=360,
            initial_loan_amount=100_000,
            forecasting_interest_rate=[2 / (12 * 100) for _ in range(360)]
        )
    ...
    def test_calculate_highest_monthly_payment(self):
        ...
        expected_highest_payment = 577  # replace with the actual expected value
    ...
    def test_calculate_total_interest_payment(self):
        ...
        expected_total_interest = 93723  # replace with the actual expected value
    ...
    def test_calculate_linked_index_payment(self):
        ...
        self.assertAlmostEqual(round(self.mortgage_track.calculate_linked_index_payment()),
                               expected_linked_index_payment,
                               places=2)

    def test_loan_cost(self):
        # Ensure that the calculated loan cost is as expected
        expected_loan_cost = 1.94  # replace with the actual expected value
    ...
    def test_calculate_total_repayment(self):
        ...
        expected_total_repayment = 193723  # replace with the actual expected value
        self.assertAlmostEqual(np.ceil(self.mortgage_track.calculate_total_repayment()), expected_total_repayment,
                               places=2)
